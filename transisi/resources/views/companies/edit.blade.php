...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('company.update',$company) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="name" id="name" value="{{ old('name') ?? $company->name }}" placeholder="Name" class="form-control">
                            @error('name')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="email" id="email" value="{{ old('email') ?? $company->email }}" placeholder="Email" class="form-control">
                            @error('email')
                                <span class="text-danger mt-2">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="row">
                         ...
                         <div class="form-group">
                           ...
                           <div class="input-group mb-3">
                            ...
                            <div class="form-group text-center my-2" id="old-img-preview">
                                <img class='img-thumbnail' style='object-fit: cover' height='250' width='250' src='{{ asset('storage/'.$company->logo) }}' alt=''/>
                            </div>
                            @endif
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Website</label>
                            <input type="text" name="website" id="website" value="{{ old('website') ?? $company->website }}" placeholder="Link Website" class="form-control">
                            @error('website')
                                <span class="text-danger mt-2">{{ $message }}</span>
                            @enderror
                        </div>
